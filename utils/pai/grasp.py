...
def GraSP(net, keep_ratio, train_dataloader, device, num_classes=10, samples_per_class=25, num_iters=1, T=200, reinit=True):
    eps = 1e-10
    old_net = net
    ...
    for layer in net.modules():
        if isinstance(layer, nn.Conv2d) or isinstance(layer, nn.Linear):
            ...
            elif isinstance(layer, nn.Conv2d) and reinit:
                #nn.init.xavier_normal_(layer.weight)
                nn.init.kaiming_normal_(layer.weight)
